 ...
 * Services
 * ============================================================ */
$pageTitle       = tr('Our Services');
$pageDescription = tr('Scrap buying services in Mecca, Jeddah & Taif, Saudi Arabia: free pickup, scrap metal buying, industrial scrap collection, vehicle scrapping, site clearance and certified weighing with instant payment.');
...
<section class="page-hero">
    <div class="container">
        <h1><?= e(tr('Our Scrap Buying Services')) ?></h1>
        <p><?= e(tr('From a single bag of copper to a complete factory load — we make selling scrap fast, fair and effortless with free pickup in Mecca, Jeddah & Taif, Saudi Arabia.')) ?></p>
    ...
    <div class="container">
        <div class="material-grid">
            ...
            <article class="material-card reveal">
                <h3><i class="fa-solid <?= e($s[0]) ?>" aria-hidden="true"></i> <?= e(tr($s[1])) ?></h3>
                <p><?= e(tr($s[2])) ?></p>
            </article>
            <?php endforeach; ?>
            <?php foreach (get_extra_services() as $es): ?>
            <article class="material-card reveal">
                <h3><i class="fa-solid <?= e($es['icon']) ?>" aria-hidden="true"></i> <?= e(tr($es['title'])) ?></h3>
                <p><?= e(tr($es['summary'])) ?></p>
            </article>
            <?php endforeach; ?>
        </div>
...
<section class="section section--surface">
    <div class="container">
        <header class="section-head">
            <p class="section-eyebrow"><?= e(tr('By Material')) ?></p>
            <h2><?= e(tr('Scrap Categories We Specialise In')) ?></h2>
        </header>
...
<section class="section">
    <div class="container split">
        <div class="split__body">
            <p class="section-eyebrow"><?= e(tr('Service Process')) ?></p>
            <h2><?= e(tr('One Call, Full Service')) ?></h2>
            <ul class="check-list mb-2">
                <li><i class="fa-solid fa-circle-check" aria-hidden="true"></i> <?= e(tr('Free pickup without minimum quantity')) ?></li>
                <li><i class="fa-solid fa-circle-check" aria-hidden="true"></i> <?= e(tr('Price confirmed before we arrive')) ?></li>
                <li><i class="fa-solid fa-circle-check" aria-hidden="true"></i> <?= e(tr('On-site certified weighing')) ?></li>
                <li><i class="fa-solid fa-circle-check" aria-hidden="true"></i> <?= e(tr('Immediate cash or transfer payment')) ?></li>
                <li><i class="fa-solid fa-circle-check" aria-hidden="true"></i> <?= e(tr('Responsible recycling of all materials')) ?></li>
            </ul>
            <a class="btn btn--wa" href="<?= e(whatsapp_link('Hello, I need a scrap pickup.')) ?>" target="_blank" rel="noopener"><?= e(tr('WhatsApp Us')) ?>
                <i class="fa-solid fa-arrow-right" aria-hidden="true"></i></a>
        </div>
        <img src="<?= e(asset('images/scrap/truck.svg')) ?>" alt="<?= e(tr('Scrap collection truck providing pickup service')) ?>" loading="lazy" width="560" height="420">
    </div>
</section>
