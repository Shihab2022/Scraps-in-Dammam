...
return [
    ...
    'from_email' => env('MAIL_FROM_EMAIL', env('ADMIN_EMAIL', 'atozscrapbuyersa@gmail.com')),
    'from_name'  => env('MAIL_FROM_NAME', 'Scraps Buyer in Saudi Arabia'),
    'to_email'   => env('ADMIN_EMAIL', 'atozscrapbuyersa@gmail.com'),
];